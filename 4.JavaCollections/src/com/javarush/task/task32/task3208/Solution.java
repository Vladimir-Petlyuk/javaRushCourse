...
public class Solution {
    ...
    public static final String UNIC_BINDING_NAMECAT = "cat";
    public static final String UNIC_BINDING_NAMEDOG = "dog";
    ...
    public static Thread SERVER_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            try {
                ...
                registry.bind(UNIC_BINDING_NAMECAT, stub);
                registry.bind(UNIC_BINDING_NAMEDOG, stub1);
