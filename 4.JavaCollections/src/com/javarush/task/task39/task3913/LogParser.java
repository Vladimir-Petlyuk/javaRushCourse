...
public class LogParser implements IPQuery, UserQuery, DateQuery, EventQuery, QLQuery {
    ...
    private void addStringEntity(Date after, Date before, Set<String> enteties, String[] parts, int part)
    {
        ...
        if (isDate(lineDateTime, after, before))
        {
    ...
    private boolean isDate(long lineDateTime, Date after, Date before)
    {
                        ...
                        switch (field2)
                        {
                            ...
                            case "status":
                                if (value1.equals(lineParts[getField2Index(field2)]))
                                {
                                    ...
                                    {
                                        Date date = getDate(lineParts[2]);
                                        if (isDate(date.getTime(), getDate(value2), getDate(value3)))
                                        {
                                            querySet.add(lineParts[0]);
                                        }
                                    } else
    ...
    {
        System.out.print(user.getProfile().getName());
        System.out.print(user.getProfile().getAddress().getState());
        System.out.print(user.getProfile().getAddress().getCity());
        System.out.print(user.getProfile().getAddress().getStreet());
        System.out.print(user.getProfile().getAddress().getHomeNumber());
    }
}